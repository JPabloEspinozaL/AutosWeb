...
<head>
    ...
    <!-- SCRIPT DE PREVISUALIZACIÓN (GLOBAL) -->
    <script>
        ...
        window.previewImage = function(url) {
            ...
            // Solo intentamos cargar si hay una URL válida (mínimo 5 caracteres)
            if (url && url.length > 5) {
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <!-- IMPORTANTE: El evento oninput llama a window.previewImage -->
                                    <input type="url" name="imagen_url" id="imagen_url" required placeholder="https://ejemplo.com/auto.jpg" 
                                           ...
                                           oninput="window.previewImage(this.value)">
                                </div>
                                <p class="mt-2 text-sm text-gray-500">Pega el enlace directo a una imagen (JPG/PNG).</p>
